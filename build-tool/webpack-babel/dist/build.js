...
var _preventExtensions = __webpack_require__(61);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/autoprefixer-loader/index.js!./test.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/autoprefixer-loader/index.js!./test.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _species = __webpack_require__(63);
...
var _cal = __webpack_require__(51);
...
btnEle.onclick = function () {
    ...
    var sum = _cal2.default.add(n1, n2); //接着过去声明这个对象的函数
...
module.exports = __webpack_require__.p + "224da23d4576f67091759e4f70d86fb2.jpg";
